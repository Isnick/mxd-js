...
add +="\t\t#d#e元宝余额：#r"+cm.getmoneyb()+"  #k  #d#e在线时间：#r" + cm.getGamePoints() + "#k分钟\r\n\r\n";
add +=   "   #L1#"+皇冠白+"时装升星#l              #L4#"+皇冠白+"勋章升星#l\r\n\r\n";
...
//------------------------------------------------------------------------
			 ...
			 if (selection == 1) {
				cm.dispose();
				cm.openNpc(9270063, "全部时装升星");
        }	
					
            if (selection == 2) {
				cm.dispose();
				cm.openNpc(9270063, "元宝武器升星");
        }		
		    if (selection == 3) {
				cm.dispose();
				cm.openNpc(9270063, "元宝戒指升星");
        }			
		 if (selection == 4) {
				cm.dispose();
				cm.openNpc(9270063, "元宝勋章升星");
        }			
