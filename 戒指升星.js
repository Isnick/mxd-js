...
function action(mode, type, selection) {
    if (mode == -1) {
        ...
        if (status == 0) {
            ...
            text += "\t\t #L48##b#v1112426#【升星】#l       #L81##b#v1112915#【升星】#l\r\n\r\n"
			//text += "#L8##b#v1112422#【升星】       \r\n\r\n"
			text += "\t\t #L4888##b#v1132115#【升星】#l       #L488##b#v1012171#【升星】#l\r\n\r\n"
			text += "\t\t\t#L8##b#i1112446#【老公老婆戒指升级】#i1112495##l\r\n\r\n"
			text += "\t\t\t#L9##b#i1122244#【超越的心项链升级】#i1122244##l\r\n\r\n"
            cm.sendSimple(text);
				...
				cm.dispose();
				cm.openNpc(3003332, "老公老婆戒指");
        }
		else if (selection == 9) {
				cm.dispose();
				cm.openNpc(3003332, "超越的心");
        }
