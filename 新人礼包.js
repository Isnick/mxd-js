...
function action(mode, type, selection) {
	if (mode == 1) {
		...
		//	cm.gainItem(1142594,10,10,10,10,0,0,10,10,0,0,0,0,10,0); //椰子内测勋章
			...
			cm.gainNX(50000);
			cm.gainDY(50000);//给予抵用卷8000点  
        //    cm.getPlayer().modifyCSPoints(1,15000, true);//点券			
			cm.sendOk("领取成功！");
