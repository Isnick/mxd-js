...
//------------------------------------------------------------------------
	...
	if (status == 0) {
		...
		add += "#L0##d#e#v1102747#城市地图#v1102747##l\t\t";

		add += "#L1##d#e#v4032138#练级地图#v4032138##l\r\n\r\n";
		
		add += "#L10##d#e#v1001017#副本地图#v1001017##l\t\t"; 
		
		add += "#L4##d#e#v1102319#跳跳地图#v1102319##l\r\n\r\n"; 
		
		add += "\t\t\t#L3##d#e#v1702477#<BOSS地图>#v1702477##l\r\n\r\n";
		
		add += "\t\t\t#L11##r#e#v1702477#<BOSS重返>#v1702477##l"; 
		cm.sendSimple (add);    
...
//------------------------------------------------------------------------
	...
	if (selection == 1) {
		var selStr = "#d　　　　　　　　　#v1312039#练级地图#v1312039##k#b";
	...
	if (selection == 3) {
		var selStr = "#k\r\n#d　　　　　　　　　#d#e#v1702477#BOSS地图#v1702477##k#b";
