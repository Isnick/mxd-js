	...
	if (mode == -1) {
		...
		if (status == 0) {
			...
			if(cm.getInventory(1).getItem(1)== null ){
             ...
             cm.sendOk("第一格装备是#v" + item.getItemId() + "#,不是炫色戒指!");
			 cm.dispose();    
			 return;
            }
				...
				sj = Math.floor(Math.random()*53);//100%
				shibai = 0;
				xxnew = "★★★★★★";
				xxdj = 5;
				点卷数量 = 330000;
			...
			cm.sendOk("升星成功！");
			cm.全服黄色喇叭(  " 【饰品升星】" + " : " + "["+cm.getPlayer().getName()+"]炫色版戒指成功提升星之力至"+xxnew+"！大家祝贺他(她)吧！！")
			cm.dispose();
				}
			}
	}}
